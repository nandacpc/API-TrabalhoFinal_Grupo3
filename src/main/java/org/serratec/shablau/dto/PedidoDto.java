...
public record PedidoDto(Long id_pedido, LocalDate data_pedido, LocalDate data_entrega, LocalDate data_envio,
		StatusEnum status_pedido, double valor_total) {
	...
	public static PedidoDto toDto(Pedido pedido) {
		return new PedidoDto(pedido.getId_pedido(), pedido.getData_pedido(), pedido.getData_entrega(),
				pedido.getData_envio(), pedido.getStatus_pedido(), pedido.getValor_total());
	}
}
