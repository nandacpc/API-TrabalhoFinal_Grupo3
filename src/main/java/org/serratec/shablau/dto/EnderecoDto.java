...
public record EnderecoDto(Long idEndereco, String cep, String rua, String bairro, String cidade, int numero,
	...
	public static EnderecoDto toDto(Endereco endereco) {
		return new EnderecoDto(endereco.getIdEndereco(), endereco.getCep(), endereco.getRua(), endereco.getBairro(),
