...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests(authorize -> authorize.requestMatchers(HttpMethod.GET, "/pedidos").permitAll()
				.requestMatchers(HttpMethod.GET, "/pedidos/{id_pedido}").permitAll()
				.requestMatchers(HttpMethod.GET, "/pedidos/{status}").permitAll()
				.requestMatchers(HttpMethod.POST, "/pedidos").hasRole("ADM").requestMatchers(HttpMethod.PUT, "/pedidos")
				.hasRole("ADM").requestMatchers(HttpMethod.PUT, "/pedidos/{id_pedido}").hasRole("ADM")
